          ...
          for (var j = 0; j < nb; j++) {
            ...
            if (overR.property == "image" || overR.property == "textStyle" || overR.property == "stringValue" || overR.property == "layerStyle" || overR.property == "symbolID") {
              ...
              if (overR.property == "image") {
                ...
                Xml.xmlAddElement(overrideParent, "override", ["property", overR.property, "value", removeIllegalXmlCharacters(overR.value), "on", overrideTargetPath, "editable", isEditable, "isDefault", isDefault], null);
